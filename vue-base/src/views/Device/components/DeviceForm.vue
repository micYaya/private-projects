<template>
  <el-form ref="formRef" :model="deviceInfo" :rules="rules">
    <el-form-item label="设备ID" prop="deviceId">
      <el-input v-model="deviceInfo.deviceId" placeholder="请输入设备ID" />
    </el-form-item>
    <el-form-item label="设备名称" prop="deviceName">
      <el-input v-model="deviceInfo.deviceName" placeholder="请输入设备名称" />
    </el-form-item>
    <el-form-item label="设备型号" prop="deviceModel">
      <el-input v-model="deviceInfo.deviceModel" placeholder="请输入设备型号" />
    </el-form-item>
    ...
    <el-form-item label="制造商" prop="manufacturer">
      <el-input v-model="deviceInfo.manufacturer" placeholder="请输入制造商" />
    </el-form-item>
    <el-form-item label="产地" prop="productionPlace">
      <el-input v-model="deviceInfo.productionPlace" placeholder="请输入产地" />
    </el-form-item>
